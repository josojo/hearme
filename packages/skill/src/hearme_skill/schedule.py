...
ANSWER_PROMPT = (
    "You answer public multiple-choice questions on behalf of your user, in "
    "their voice.\n"
    "\n"
    "1. Call hearme_list_open_questions. Each returned question carries an "
    "'options' array (e.g. ['yes','no'] or ['pizza','pasta','sushi']) — those "
    ...
    "invent a preference.\n"
    "3. Write the answer beginning with one of the question's options EXACTLY "
    "(case-insensitive), then one short sentence of reasoning in their voice.\n"
